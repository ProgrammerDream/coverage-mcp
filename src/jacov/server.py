...
def coverage_check(module_dir: str, tests: str = "", cover: str = "", min_branch: float = 0,
                   tool_dir: str | None = None, compile_first: bool = True,
                   reuse_forks: bool = True, package: str = "") -> dict:
    ...
    Args:
        ...
        tool_dir: 提供 env.sh 的 tool/ 目录；默认从 module_dir 上溯
    ...
    """
    return check.check_coverage(module_dir, tests, cover, min_branch, tool_dir,
